...
翔泳社刊 https://www.shoeisha.co.jp/book/detail/9784798183664[『Next.js＋ヘッドレスCMSではじめる！かんたんモダンWebサイト制作入門』]の第９章と同じようなお問い合わせフォームをフォーム作成ツール https://form.run/home[formrun] で実装することを試みて、成功した。けっこういい感じだ。
